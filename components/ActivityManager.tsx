            ...
            >
              ...
              <div className="p-5 flex-1">
                <div className="flex justify-between items-start mb-3">
                  <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-full ${subjectInfo?.color.replace('bg-', 'bg-opacity-10 text-')} text-white flex items-center gap-1`}>
