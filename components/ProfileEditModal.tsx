...
import { GraduationCap, BookOpen, Calculator, Globe, FlaskConical, Clock, Map, Trophy, X } from 'lucide-react';
...
const ProfileEditModal: React.FC<Props> = ({ userId, fullName, subjects, years, onProfileUpdated, onClose }) => {
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-8 flex flex-col gap-6">
          ...
          <p className="text-slate-500 text-sm">
            Bonjour <span className="font-bold text-slate-700">{fullName}</span> — modifiez vos matières et années ci-dessous.
          </p>

          {/* Matières */}
          <div className="space-y-3">
            <label className="text-xs font-black uppercase tracking-widest text-slate-400">Vos matières</label>
          ...
          {/* Années primaire */}
          <div className="space-y-3">
            <label className="text-xs font-black uppercase tracking-widest text-slate-400">Années — Primaire</label>
          ...
          {/* Années secondaire */}
          <div className="space-y-3">
            <label className="text-xs font-black uppercase tracking-widest text-slate-400">Années — Secondaire</label>
            <div className="flex gap-2">
